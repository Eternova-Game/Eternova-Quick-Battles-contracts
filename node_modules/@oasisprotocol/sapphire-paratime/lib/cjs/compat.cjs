...
function wrap(upstream, customCipher) {
    ...
    if (isEthers5Signer(upstream)) {
        ...
        const hooks = {
            ...
            estimateGas: () => __awaiter(this, void 0, void 0, function* () { return bignumber_1.BigNumber.from(DEFAULT_GAS); }),
...
function isEthers6Signer(upstream) {
    return upstream instanceof ethers6_1.ethers.AbstractSigner;
}
function isEthers6Provider(upstream) {
    return upstream instanceof ethers6_1.ethers.AbstractProvider;
}
    ...
    return (call) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (isEthers6Signer(runner)) {
            ...
            if (yield callNeedsSigning(call)) {
                const dataPack = yield signed_calls_js_1.SignedCallDataPack.make((yield undefer(call)) /* callNeedsSigning ensures type */, signer);
...
function repackRawTx(raw, cipher, signer) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const tx = ethers6_1.ethers.Transaction.from(raw);
        const q = (v) => {
            if (!v)
                return undefined;
            return ethers6_1.ethers.toQuantity(v);
        };
        const parsed = {
            to: tx.to,
            from: tx.from,
        ...
        if (provider && 'send' in provider) {
            ...
            try {
                ...
                if (!isEthersSigner &&
                    ...
                    resp = yield source.send({ method: index_js_1.OASIS_CALL_DATA_PUBLIC_KEY, params: [] }, truffle_callback);
                    if (resp === undefined) {
