...
export class Cipher {
    ...
    encryptEnvelope(plaintext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, nonce } = yield this.encryptCallData(arrayify(plaintext));
    ...
    decryptEncoded(callResult) {
        return __awaiter(this, void 0, void 0, function* () {
            return hexlify(yield this.decryptCallResult(cbor.decode(arrayify(callResult))));
        });
    }
...
export class X25519DeoxysII extends Cipher {
    ...
    static ephemeral(peerPublicKey) {
        ...
        return new X25519DeoxysII(keypair, arrayify(peerPublicKey, { allowMissingPrefix: true }));
    }
 ...
 */
export function lazy(generator) {
